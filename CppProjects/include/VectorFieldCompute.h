...
public:
    ...
    AnalyticalFlowFunc2D analyticalFlowfunc_ = nullptr;
    inline Eigen::Vector2d getSpatialMinBoundary() const { return spatialDomainMinBoundary; }
    inline Eigen::Vector2d getSpatialMaxBoundary() const { return spatialDomainMaxBoundary; }
